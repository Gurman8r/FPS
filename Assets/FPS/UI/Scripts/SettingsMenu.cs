    ...
    public class SettingsMenu : MonoBehaviour
    {
        ...
        * * * * * * * * * * * * * * * */
        ...
        public void LoadSettings()
        {
            ...
            {
                FP_Camera.main.lookSensitivity = new Vector2(s.value, FP_Camera.main.lookSensitivity.y);
            });

            // Look Sensitivity Y
            SetupSlider(m_lookSensitivityY, "LookSensitivityY", 0.1f, (Slider s) =>
            {
                FP_Camera.main.lookSensitivity = new Vector2(FP_Camera.main.lookSensitivity.x, s.value);
            });

            // Field of View
            SetupSlider(m_fieldOfView, "FieldOfView", 60f, (Slider s) => 
            {
                FP_Camera.main.fieldOfView = s.value;
            });
            ...
            {
                FP_Camera.main.postProcessing.profile.antialiasing.enabled = t.isOn;
            });
            ...
            {
                FP_Camera.main.postProcessing.profile.vignette.enabled = t.isOn;
            });
