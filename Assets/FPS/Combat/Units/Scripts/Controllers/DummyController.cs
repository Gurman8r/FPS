...
namespace FPS
{
    public class DummyController : RobotController
    {
        /* Variables
        * * * * * * * * * * * * * * * */
            ...
            if (Application.isPlaying)
            {
                ...
                if (self.combat.inCombat)
                {
                    m_text.text = string.Format(m_format,
                        ...
                        m_hitCount,
                        FormatFloat(self.combat.outOfCombatTimer));
                ...
                else
                {
                    ...
                    if (self.health.fillAmount < 1f)
                    {
                        self.triggers.OnReceiveHealing(new HealingEventData(self, self, m_regen * Time.deltaTime));
