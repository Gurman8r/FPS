...
namespace FPS
{
    ...
    public abstract class BaseEntity : MonoBehaviour
    {
        ...
        * * * * * * * * * * * * * * * */
        ...
        [SerializeField] MotionData m_motion;
        ...
        * * * * * * * * * * * * * * * */
        ...
        {
            other?.triggers.OnReceiveDamage(new DamageEventData(owner, other, m_damage));
        }
        ...
        public void SpawnObject(BaseEntity prefab)
        {
            BaseEntity obj;
